...
require (
	...
	github.com/jpfluger/alibs-slim/aconns/aclient-ftp v0.9.9
	github.com/jpfluger/alibs-slim/aconns/aclient-http v0.9.9
	github.com/jpfluger/alibs-slim/aconns/aclient-ldap v0.9.9
	github.com/jpfluger/alibs-slim/aconns/aclient-redis v0.9.9
	github.com/jpfluger/alibs-slim/aconns/aclient-smtp v0.9.9
	github.com/jpfluger/alibs-slim/aconns/adb-mssql v0.9.9
	github.com/jpfluger/alibs-slim/aconns/adb-mysql v0.9.9
	github.com/jpfluger/alibs-slim/aconns/adb-oracle v0.9.9
	github.com/jpfluger/alibs-slim/aconns/adb-pg v0.9.9
