...
// CompilerMarkdownHtml is a struct that holds an HTML template.
type CompilerMarkdownHtml struct {
...
func (c *CompilerMarkdownHtml) Run(body string, params ...interface{}) (returnedItem interface{}, err error) {
...
func (c *CompilerMarkdownHtml) Render(body string, params ...interface{}) (string, error) {
